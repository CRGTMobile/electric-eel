...
namespace SitefinityWebApp.Forms.DateTimeField
{
    /// <summary>
    ...
    public class DateTimeField : FieldControl, IFormFieldControl
    {
        ...
        public override object Value
        {
            get
            {
                return this.DateTimePicker.SelectedDate.Value;
            }

            set
            {
                this.DateTimePicker.SelectedDate = (DateTime)value;
            }
        }
        #endregion
        ...
        /// </summary>
        protected virtual RadDateTimePicker DateTimePicker
        {
            get
            {
                return this.Container.GetControl<RadDateTimePicker>("dateTimePicker", true);
            }
        }
        #endregion
        ...
        protected override void InitializeControls(GenericContainer container)
        {
            ...
            this.DateTimePicker.SelectedDate = DateTime.Now;
        }
        #endregion
